( define (problem mountResc11People)
( :domain mountainRescueDomain)
( :objects
	h0 h1 - helicopter
	p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 - personToBeRescued
	d0 d1 - paramedic
	cc0 cc1 - cableCar
	amb0 amb1 - ambulance
...
( :goal
( and 	( personAt p0 baseOfMountain)
( personAt p3 baseOfMountain)
	( personAt p5 baseOfMountain)
	( personAt p6 baseOfMountain)
	( personAt p1 medCen)
	( personAt p2 medCen)
	( personAt p4 medCen)
	( personAt p7 medCen)
